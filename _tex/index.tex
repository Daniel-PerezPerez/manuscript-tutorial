...
\hypersetup{
  ...
  pdfauthor={Steve Purves; Rowan Cockett; Dummy E. Author},
...
\authors{Steve Purves\affil{1}, Rowan Cockett\affil{1}, Dummy E.
Author\affil{2}}
\affiliation{1}{Curvenote, }\affiliation{2}{La Palma University, }
...
Nacional (IGN). We aimed at describing alternative methods to describe
the probability of a new eruption considering historical data.
\end{abstract}

\section*{Plain Language Summary}
Earthquake data for the island of La Palma from the September 2021
eruption is found in the database of the Instituto Geográphico Nacional
(IGN). Current methods of statistical probability have limited
advantages in the prediction of new eruptions.
...
\textsubscript{Source:
\href{https://Daniel-PerezPerez.github.io/manuscript-tutorial/index.qmd.html}{Article
Notebook}}
...
Based on data up to and including 2021, eruptions on La Palma happen
